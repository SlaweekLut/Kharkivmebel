...
export const popupFn = () => {
	...
	const catalogMaterials = popupOpener(
		...
		[
			...document.querySelectorAll('.-hm-popup-catalog__close'),
	...
	const searchMobile = popupOpener(
		document.querySelector('.-hm-mobile-search-wrapper'),
		[...document.querySelectorAll('.js-search-mobile')],
		[...document.querySelectorAll('.-hm-mobile-search-header__close')],
		null,
	);

	const topHeader = document.querySelector('.-hm-header-top')
	const stickyHeader = document.querySelector('.-hm-header--sticky')
	const closeTopHeader = document.getElementById('js-close-top')
...
export const choiceMulti = () => {
	...
	const auth = choiceOneFn(
		document.querySelectorAll('.-hm-popup-auth__button'),
		document.querySelectorAll('.-hm-popup-auth-form'),
	);
};
